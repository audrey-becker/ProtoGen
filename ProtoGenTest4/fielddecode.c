// fielddecode.c was generated by ProtoGen version 3.1.d
...
{
    return float24ToFloat32(uint24FromBeBytes(bytes, index), sigbits);
}
...
{
    return float24ToFloat32(uint24FromLeBytes(bytes, index), sigbits);
}
...
{
    return float16ToFloat32(uint16FromBeBytes(bytes, index), sigbits);
}
...
{
    return float16ToFloat32(uint16FromLeBytes(bytes, index), sigbits);
}
